...
<head>
    ...
    <title>TMS-Project | BULUNAMADI</title>
    ...
    <section class="error">
        ...
        <div class="error__content">
            <div class="error__message message">
                <h1 class="message__title">SİPARİŞİNİZ BULUNAMADI</h1>
                <p class="message__text">Siparişiniz henüz işleme alınmamış ya da tamamlanmış olabilir.</p>
            </div>
        </div>
        <!-- END Content -->
