                            ...
                            <table id="vehiclesTable" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th><a href="{{ route('get.wms.location.add') }}"><i
                                    ...
                                    @if ($locations != null)
                                        @foreach ($locations as $location)
                                            <tr>
                                                ...
                                                <td>{{ $location->address_description }}</td>
                                                <td>{{ $location->authorized_person }}</td>
                                                <td>{{ $location->email }}</td>
                                                <td>{{ $location->phone }}</td>
                                                <td>{{ $location->capacity }}</td>
                                                <td></td>
                                                <td>
                                                    <a href="{{ route('get.wms.location.edit', ['id' => $location->id]) }}"><i
                                                            class="fa fa-pen"></i></a>
                                                    <a
                                                        href="{{ route('get.wms.location.delete', ['id' => $location->id]) }}"><i
