                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header">
                                ...
                                @can('view-preorder', $order->customer)
                                    ...
                                    @switch($order->status)
                                        @case(1)
                                            <a style="padding: 0 10px"
                                                href="{{ route('get.tms.preorder.delete', ['id' => $order->id]) }}">
                                                <i class="nav-icon fa fa-trash"></i>
                                                SİL
                                            </a>
                                            <a style="padding: 0 10px"
                                                href="{{ route('get.tms.preorder.close', ['id' => $order->id]) }}">
                                        ...
                                        @case(2)
                                            <strong> SİPARİŞ OLUŞTURULDU </strong>
                                        @break
                                    @endswitch
                                </div>
                            </div>
