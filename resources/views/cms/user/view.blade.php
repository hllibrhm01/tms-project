                        ...
                        <div class="card-header">
                            <div class="float-right">
                                <a style="padding: 0 10px"
                                    href="{{ route('get.cms.user.delete', ['id' => $user->id]) }}">
                                    <i class="nav-icon fa fa-trash"></i>
                                    SİL
                                </a>
                                <a style="padding: 0 10px"
                                    href="{{ route('get.cms.user.edit', ['id' => $user->id]) }}">
                                    ...
                                    <div class="card-body" style="pointer-events: none;">
                                        <div class="row p-2">
                                            <div class="col-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <input type="text" class="form-control" name="name" placeholder="İsim Soyisim giriniz" value="{{ $user->name }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <input type="email" class="form-control" name="email" placeholder="E-mail giriniz" value="{{ $user->email }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <select class="form-control" id="role_id" name="role_id">
                                                            <option data-select2-id="0">Seçiniz</option>
                                                            @if (!is_null($roles))
                                        ...
                                        <div class="row p-2">
                                            <div class="col-6">
                                                <div class="row">
                                                    <div class="col-6 mt-2">
                                                        <label class="control-label" for="ms_id">Müşteri Tanımlama : </label>
                                                    </div>
                                                    <div class="col-6">
