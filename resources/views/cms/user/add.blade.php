                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="{{ route('post.cms.user.add') }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row p-2">
                                            <div class="col-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <input type="text" style="text-transform: uppercase;" class="form-control" name="name" placeholder="İsim Soyisim giriniz">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <input type="email" style="text-transform: lowercase;" class="form-control" name="email" placeholder="E-mail giriniz">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <select class="form-control" id="role_id" name="role_id">
                                                            <option data-select2-id="0" value="0" selected>Seçiniz</option>
                                                            @if (!is_null($roles))
                                                            @foreach ($roles as $role)
                                                            <option value={{ $role->id }} data-select2-id="{{ $role->id }}">
                                                                {{ $role->name }}
                                                            </option>
                                                            @endforeach
                                                            @endif
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <select class="form-control" id="vehicle_id" name="vehicle_id">
                                                            ...
                                                            <option value={{ $tms_vehicle->id }} data-select2-id="{{ $tms_vehicle->id }}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <select class="form-control" id="tms_id" name="tms_id">
                                                            ...
                                                            <option value={{ $tms_customer->id }} data-select2-id="{{ $tms_customer->id }}">
